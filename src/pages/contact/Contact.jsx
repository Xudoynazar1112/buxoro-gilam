    ...
    <div className="md:flex md:gap-10 w-full">
      <div className="md:w-1/2 w-full">
        ...
        <form className="flex flex-col gap-5" onSubmit={SendMessage} id="forma">
            <input className="bg-gray-300 w-full p-2 rounded-xl" type="text" name="email" id="email" placeholder="Sizning elektron pochtangiz" required />
            <input className="bg-gray-300 w-full p-2 rounded-xl" type="number" name="phone" id="phone" placeholder="Telefon raqamingiz" required />
            <input className="bg-gray-300 w-full p-2 rounded-xl h-44 " type="text" name="message" id="message" placeholder="Sizning xabaringiz shu yerda" required />
